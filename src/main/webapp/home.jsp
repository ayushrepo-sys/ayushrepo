...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main>
        <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
            <div class="carousel-indicators"> <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="0"
                    ...
                    data-bs-target="#myCarousel" data-bs-slide-to="1" aria-label="Slide 2"></button> <button
                    type="button" data-bs-target="#myCarousel" data-bs-slide-to="2" aria-label="Slide 3"></button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://empxtrack.com/wp-content/uploads/2009/07/leave-management-system.jpg" class="bd-placeholder-img " height="100%"
                ...
                <div class="carousel-item"> 
                    <img src="https://blog.minopcloud.com/AssetsNew/images/post-img/2022/lg/Leave-Management-System-for-HR.jpg" class="bd-placeholder-img " height="100%"
                        preserveAspectRatio="xMidYMid slice" width="100%" >"
                    <div class="container">
                ...
                <div class="carousel-item"> 
                    <img src="https://trackobit.com/wp-content/uploads/Leave-Attendance-Management-System-How-Does-it-Help-HR-Managers.jpg" class="bd-placeholder-img " height="100%"
                        preserveAspectRatio="xMidYMid slice" width="100%" >"
  ...
  ================================================== -->
        ...
        <div class="container marketing"> <!-- Three columns of text below the carousel -->
            <div class="row">
                <div class="col-lg-4"> 
                    <img src="https://www.shutterstock.com/image-photo/staff-working-document-management-system-260nw-2133397111.jpg" class="bd-placeholder-img rounded-circle"
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5 order-md-1">
                    ...
                    <img src="https://global.discourse-cdn.com/monday/original/3X/5/a/5a680d13c9a083179cd74201aeb44fda65ac3a73.jpeg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" height="500"
            ...
            <div class="row featurette">
                ...
                <div class="col-md-5">
                    ...
                    <img src="https://www.orangehrm.com/assets/Uploads/Leave-Time-Off-Management-System.jpg" class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" height="500"
                        preserveAspectRatio="xMidYMid slice" role="img" width="500" >
            </div>
