  ...
  <div class="container">
    <div class="row gy-4 gy-lg-0 align-items-lg-center">
      <div class="col-12 col-lg-6">
        <img class="img-fluid rounded border border-dark" loading="lazy" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmvAPlGq8uWU7COycuhdYB6CvDJKTdB9GFbw&s" alt="About Us">
      </div>
